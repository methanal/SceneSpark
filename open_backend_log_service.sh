...
sudo docker run --name backendlog -p 0.0.0.0:11002:80 -v ${LOG_PATH}:/tmp/backend.log -v ${HOME}/SceneSpark/pv-data/nginx/backendlog.dev.conf:/etc/nginx/conf.d/default.conf:ro --platform=linux/amd64 -d nginx
